              ...
              child: Column(
                ...
                Padding(
                  ...
                  child: Row(
                    children: [
                      ...
                      Expanded(
                        child: CustomDurationCard(
                          iconPath: "assets/icon/clue.svg", // Custom icon path
                          duration: "${data[index!].clues.length.toString()} clues", // Custom duration value
                ...
                Padding(
                  ...
                  child: CustomDurationCard(
                    ...
                    duration: "${data[index!].price.toString()}", // Custom duration value
                    ...
                    child: Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SingleChildScrollView(
                                  child: Text(
                                    "\"Where time stands still and history speaks. Look for the guardian that never sleeps. Bronze and proud, watching square, Your first secret waits for those who dare.\"",
                                    textAlign: TextAlign.start,
                                    style: customTextStyleAuth(
                                      fontSize: 14,
                                      fontWeight: FontWeight.w400,
                          ...
                          InkWell(
                            onTap: (){
                              Navigator.push(context, MaterialPageRoute(builder: (_)=> AllCluesScreen(index: index,))); 
                            },
                            child: DecoratedBox(
                              decoration: BoxDecoration(
                                color: blue1,
               ...
               data[index!].status == ClueStatus.completed ? SizedBox() :  Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: CustomButton(
                    onPressed: (){
                      Navigator.push(context, MaterialPageRoute(builder: (_)=> CluesScreen(index: index,)));
                    },
